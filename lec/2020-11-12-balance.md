...
![Easy: dependency-free loop (Jacobi sweep)](figs/lb-deps-easy.svg){width=70%}

![Harder: tasks have predictable structure (some DAG)](figs/lb-deps-harder.svg){width=30%}

![Hardest: structure is dynamic (search, sparse LU)](figs/lb-tree-search.svg){width=20%}
