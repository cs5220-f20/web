...
![](figs/part-mat2graph.svg "Partitioning of matrix and associated graph"){width=60%}
...
![](figs/part_esep_spectral.svg){width=40%}
...
![](figs/part_coarsen.svg){width=40%}
