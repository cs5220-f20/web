...
[](https://pbs.twimg.com/media/EoX5OwBUUAENjhm?format=jpg&name=medium){width=30%}

### Some history: Von Neumann and Goldstine

![](figs/von-neumann.jpg){height="4cm"}
![](figs/goldstine.jpg){height="4cm"}
...
![image](figs/turing.jpg){height="5cm"}
...
![image](figs/wilkinson.jpg){height="3cm"}
...
![image](figs/kahan.jpg){height="3cm"}
...
Normalized numbers:
$$(-1)^s \times (1.b_1 b_2 \ldots b_p)_2 \times 2^e$$ Have 32-bit
single, 64-bit double numbers consisting of
